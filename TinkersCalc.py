...
header.pack()
direction = Label(text="Please fill out all options then click the Calcuate button to figure out how many resources you need to create a smeltery of that size.")
direction.pack()
